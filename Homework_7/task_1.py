...
class Segment:
    ...
    def x_axis_intersection(self):
        """
        Проверяет пересекает лм отрезок ось абцисс
        :return True: если отрезок пересекает ось абцисс
        False: если отрезок не пересекает ось абцисс
        :rtype: object
        """
    ...
    def y_axis_intersection(self):
        """
Проверяет пересекает лм отрезок ось ординат
        :return True: если отрезок пересекает ось ординат
        False: если отрезок не пересекает ось ординат
        :rtype: object
        """
